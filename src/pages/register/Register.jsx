...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!inputs.username.trim()) {
      ...
      hasBasicErrors = true;
    } else if (inputs.username.trim().length > 16) { // Added username length validation
      newValidationErrors.username = "Username must be less than 17 characters.";
      hasBasicErrors = true;
    }
    ...
    try {
      await axios.post("http://34.219.141.197:8080/api/auth/register", inputs);
